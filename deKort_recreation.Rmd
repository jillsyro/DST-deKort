...
-The repository for Plasticity is well-organized and annotated with examples of how to run code producing figures and results.  
...
-I decided to research the foundation of RDPI in Valladares et al. (2006) to see if I could understand the math behind the rdpi command. I found this equation:  
