...
##Summary
-Due to the availability of RDPI data provided by the authors, I concluded that I would easily be able to reproduce their figures.
-I was not able to reproduce their data analysis techniques, which is a great detriment to the reproducibility of the paper as a whole.  
